/*
 * File: Class file to make our J-Shaped piece.
 * 
 * CS 342, Spring 2016
 * Project 5: Tetris
 * 
...
public class JBlock implements Tetromino {
 ...
 private Block one = new Block(Color.BLUE);
 private Block two = new Block(Color.BLUE);
 private Block three = new Block(Color.BLUE);
 private Block four = new Block(Color.BLUE);

 public JBlock(Block[][] grid) {
  grid[3][0] = one;
  grid[3][0] = two;
  grid[4][0] = three;
  grid[5][0] = four;
