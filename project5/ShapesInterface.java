/*
 * File: Class file to make our Shapes Interface. The purpose of this class is to use the Factory Design Pattern efficiently.
 * 
 * CS 342, Spring 2016
 * Project 5: Tetris
 * 
...
public interface ShapesInterface 
{
  ...
  int getx(int ind);
  int gety(int ind);
  Shapes.Tetrominoes newShape();
  Shapes rotateLeft() ;
  Shapes rotateRight();
  int minx();
  int minY();
  void getRandShape();
  void displayShape(String piece);
}