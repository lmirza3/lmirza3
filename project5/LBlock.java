/*
 * File: Class file to make our L-Shaped piece.
 * 
 * CS 342, Spring 2016
 * Project 5: Tetris
 * 
...
public class LBlock implements Tetromino {
 ...
 private Block one = new Block(Color.ORANGE);
 private Block two = new Block(Color.ORANGE);
 private Block three = new Block(Color.ORANGE);
 private Block four = new Block(Color.ORANGE);

 public LBlock(Block[][] grid) {
  grid[3][0] = one;
  grid[4][0] = two;
  grid[5][0] = three;
  grid[5][0] = four;
